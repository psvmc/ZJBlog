...
/**
 * 包含Header和Footer 如果不需要头部和尾部，就建一个高度为0的view
 * Created by PSVMC on 16/7/6.
 */
public abstract class ZJCommonAdapterWithHeaderAndFooter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
